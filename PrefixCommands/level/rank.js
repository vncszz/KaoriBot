...
module.exports = {
    ...
    run: async (client, message, args) => {
        ...
        if (!rank) {
            return message.reply(`looks like you have 0 xp`)
        }
        ...
        let rankCard = new canvacord.Rank()
            ...
            .setRank(rank.rank + 1)
            .setBackground("IMAGE", "https://cdn.discordapp.com/attachments/1083539979101290666/1092836520584552498/download_1.jpeg")

        rankCard.build().then((data) => {
            let attach = new Discord.AttachmentBuilder(data, 'rank.png')
